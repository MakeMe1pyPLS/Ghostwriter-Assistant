        ...
        return (
          <div className="h-full flex flex-col">
            <div className="flex items-center justify-between mb-8">
               <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{widget.title || 'Network Throughput'}</h3>
            </div>
      ...
      <div className="p-10 max-w-[1600px] mx-auto">
        <header className="flex justify-between items-center mb-10">
          ...
          <div className="flex gap-2 md:gap-4 flex-wrap">
             <ExportDrawer layout={layout} widgets={widgets} sector={sector} />
        ...
        <div className="bg-transparent overflow-hidden">
          <MeasuredGrid
            ...
            layouts={{
              ...layouts,
              lg: layouts.lg?.map((l: any) => ({ ...l, static: true })) || layout.map(l => ({ ...l, static: true }))
            }}
