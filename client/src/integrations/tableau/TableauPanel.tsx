...
import { CloudCog, Clock } from "lucide-react";
    ...
    <Card className="border-slate-200 shadow-sm opacity-80">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-sm font-black uppercase tracking-widest">Tableau</CardTitle>
      ...
      <CardContent>
        <div className="space-y-3 text-xs text-slate-600">
          <p className="font-medium leading-relaxed">Generate Tableau-compatible data extracts and packaged workbook templates for Tableau Server or Cloud.</p>
          <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
            ...
            <ul className="space-y-1 text-xs text-slate-500 font-medium">
              <li>• .twbx workbook generation</li>
              <li>• Hyper data extract creation</li>
              <li>• Tableau Server publishing</li>
